...
* **API & Arquitetura:** APIs RESTful, Sistemas Distribuídos (Microsserviços), Comunicação Baseada em Eventos (EDA), Clean Code e Padrões de Projeto (Design Patterns).
* **Segurança & Dados:** Autenticação Stateless (JWT), Prevenção a Vulnerabilidades (Anti-IDOR) e Consistência Transacional (@Transactional).
* **Integrações & Baixo Nível:** Integração com Periféricos/Hardware (JNA/JNI), Protocolos de Redes e Análise de Logs em Produção.
* **Metodologias & Cultura:** Scrum, Metodologias Ágeis, Versionamento Semântico, CI/CD e Conventional Commits.
